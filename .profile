...
alias wsock="cd $ROOT_DIRECTORY/status_files; nohup websocat -tvvv autoreconnect:ws://$(cat $ROOT_DIRECTORY/status_files/kappe_ip):$WEBSOCKET_PORT writefile:$ROOT_DIRECTORY/status_files/websocket_output --ping-interval 60 --autoreconnect-delay-millis 5000 & >> $ROOT_DIRECTORY/wsock_stout.log 2>> $ROOT_DIRECTORY/wsock_error.log"
